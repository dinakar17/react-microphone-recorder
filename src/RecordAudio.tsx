...
const RecordAudio: React.FC<RecordAudioProps> = (props) => {
  ...
  return (
    <div className='border relative flex flex-col justify-center items-center h-72 w-full shadow-lg rounded-md'>
      ...
      <div className='mt-24'>
        {recordingState === 'idle' && (
          <button className='flex gap-1 bg-blue-500 text-white px-4 py-2 rounded-md' onClick={startRecording}>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='24'
              height='24'
          ...
          <div className='flex flex-col items-center'>
            <div className='flex justify-center items-center gap-2'>
              {recordingState === 'recording' && (
                <button className='flex gap-1 bg-red-500 text-white px-4 py-2 rounded-md' onClick={pauseRecording}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    width='24'
                    height='24'
              ...
              {recordingState === 'paused' && (
                <button className='flex gap-1 bg-green-500 text-white px-4 py-2 rounded-md' onClick={resumeRecording}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    width='24'
                    height='24'
              ...
              <button className='flex gap-1 bg-blue-500 text-white px-4 py-2 rounded-md' onClick={stopRecording}>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='24'
                  height='24'
        ...
        {recordingState === 'stopped' && (
          <div className='flex flex-col items-center'>
            <div className='flex justify-center items-center gap-4'>
              ...
              <button className='flex gap-1 bg-blue-500 text-white px-4 py-2 rounded-md' onClick={resetRecording}>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='24'
                  height='24'
